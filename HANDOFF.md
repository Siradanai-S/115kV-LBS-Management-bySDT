...
- **schema ที่ต้องรันสะสม:** projects.bom_rounds · customers.project_name/contract_file_* · bom_items.cust_id · service_plans.checkin_*/cust_id/approved/approved_by/has_po/advance_payment · RLS p_proj_del(+project) / p_plans_upd(+executive) / p_notif read-all · **item_catalog (ตาราง+RLS)** · handoff_project (service gate กรอง approved)
